...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Define the FormSubmit URL
      const formSubmitUrl = 'https://formsubmit.co/angeloadvincula0@gmail.com';
      ...
      submitData.append('_subject', 'New Contact Form Submission'); // Optional: Set a subject for the email
      submitData.append('_captcha', 'false'); // Disable captcha if you don't want it
